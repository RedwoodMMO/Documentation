...
- Added support for [blob storage](/docs/features/data/storage/blob-storage)
- Added an opt-out Kubernetes dependency SeaweedFS which provides S3 storage; read more [here](/docs/features/data/storage/blob-storage#seaweedfs)
- Initial implementation of custom probes for Kubernetes health checks
- Fixed issue with Instanced Dungeons not being able to return to the overworld

## Misc changes

[World Data](/docs/features/data/game/world-data) and [Persistent Items (3.0 renamed these to Sync Items)](/docs/features/sync-items) now have docs and are officially released!
