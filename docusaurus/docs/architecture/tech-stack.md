...
- [Node.js](https://nodejs.org): The runtime for the Redwood backend services
...
- [SocketIO](https://socket.io/): The network layer used for connections with any of the Node.js services
